...
const MarchantSection = () => {
    return (
        <div className=" bg-gradient-to-br from-[#0d3b36] to-[#0a2e2a] text-white shadow-xl p-8 md:p-12 m-2 md:m-0 relative overflow-hidden rounded-[15px]">
            <div className="absolute top-0 left-0 w-full">
                <img src={headerImage} alt="headerImage" className="w-full block" />
            </div>
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
                <div>
                    <h5 className="text-4xl font-bold text-white p-2">Merchant and Customer Satisfaction is Our First Priority.</h5>
                    <p className="text-lg text-gray-400 p-2">We Offer the lowest delivery charge with the highest value along with a wide range of services. Courier Services are available for all major cities.</p>
                    <div>
